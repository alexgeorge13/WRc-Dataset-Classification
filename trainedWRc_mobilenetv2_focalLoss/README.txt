...
* To load the model with weights:
    ...
    import trainedWRc_mobilenetv2_focalLoss
    model = trainedWRc_mobilenetv2_focalLoss.load_model()


* To load the model without weights:

    import trainedWRc_mobilenetv2_focalLoss
    model = trainedWRc_mobilenetv2_focalLoss.load_model(load_weights=False)
